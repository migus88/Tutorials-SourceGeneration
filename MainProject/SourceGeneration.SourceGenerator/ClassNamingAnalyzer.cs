...
namespace SourceGeneration.SourceGenerator
{
    ...
    {
        private const string DiagnosticID = "TEST001"; //Error code ID
        private const string Title = "Class naming conventions analyzer"; //The title of the analyzer
        private const string MessageFormat = "Class name must be written in PascalCase"; //The message for the developer
        private const string Category = "Declaration"; //Category of this analyzer
        private const DiagnosticSeverity Severity = DiagnosticSeverity.Warning; //The severity of the issue
